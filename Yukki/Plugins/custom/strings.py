...
💌↜ اهلا بك في {BOT_NAME} تستطيع تشغيل الاغاني والفيديوهات في المكالمات الصوتية

💻↜ في مواجهة اي مشكله في استخدام البوت تواصل مع المطور ↜💕 @dont_run
"""

COMMANDS_TEXT = f"""
✨ **مرحبا MENTION !**

**انقر علي الزراير لاظهار الاوامر 💕.**
"""
...
START_BUTTON_GROUP = InlineKeyboardMarkup(
    [   
        ...
        [
            InlineKeyboardButton(
                text="Channel 💌", url="https://t.me/NiNJa_SuPPoORT"
            ),
            InlineKeyboardButton(
                text=" Developer 💌", url="https://t.me/dont_run"
            ),                       
        ],        
    ]
)
...
START_BUTTON_PRIVATE = InlineKeyboardMarkup(
    [   [
            InlineKeyboardButton(
                text="⌯ Add Me To Your Group ⌯", url=f"https://t.me/NiNjaSoNgs_bot?startgroup=true"
            ),            
        ],
        [   
            InlineKeyboardButton(
...
SUDO_BACK_BUTTON = InlineKeyboardMarkup(
    [   [
            InlineKeyboardButton(
                text="More Sudo Commands", url="https://telegra.ph/NINJA-SONGS-02-10"
            ),                        
        ],
        [
            InlineKeyboardButton(
